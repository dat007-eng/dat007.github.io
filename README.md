          ...
          <div class="col-12">
            ...
            <div class="ml-auto mr-0 tm-bg-black-transparent text-white tm-brand-container-inner">
              <div class="tm-brand-container text-center">
                <h1 class="tm-brand-name">Dat Profile</h1>
                <p class="tm-brand-description mb-0">Dat think about IT world</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row h-100">
            ...
            <div class="col-md-7 tm-welcome-left-col">
              <div class="tm-welcome-left">
                <h2 class="tm-welcome-title">Team profile and team Name</h2>
                <p class="pb-0">
                  about team profile and team Name </p>
              </div>
            </div>
            <!-- Brown bg -->
            <div class="col-md-5">
            ...
            <div class="tm-portfolio-item">
              ...
              <div class="tm-portfolio-description">
                <h3 class="tm-text-green">
                  project idea
                  <span class="tm-title-small">(AR software)</span>
                </h3>
                <p class="mb-0">
                <p>Overview:</p>
<p>My project is making an AR software which is using the user’s environment in reality. AR can help people using the real-world environment to run the software. </p>
<p>Motivation:</p>
<p>Nowadays, most of the software is making an artificial environment in which people can not have a better experience in real life. Therefore, it is different from other software is using real-world data to the user who has experiences of interacting personally with their real environment.  By using an existing environment, AR will change in different places we run the software. According to financesonline.com, in 2019, there are 68.7 million American use AR once per month and 2.5 billion gamers in the world. there is a quote said:” VR slows as AR grows” mean the more the number of VR’s user is decreasing, the more the number of AR’s user is increasing. </p>
<p>Description : </p>
<p>Feature:</p>
<p>AR can help people interact with their real environment and real-time which was controlled by an AI software. It has two basic feature which is a combination of the real and virtual world and real-time interaction and accurate 3D using the virtual and real object.</p>
<p>1.	A combination of the real and virtual world and real-time interaction</p>
<p>a)	Video game</p>
<p>It makes an AR game which is an interactive network by using the real environment as a platform and make a story by user real action and environment. The story of the game will change base on user response to the game by real action. However, it combines the virtual and real character to make the player immerse to their own real and virtual environment. The game will run by how people do real action.  
...
https://en.wikipedia.org/wiki/Augmented_reality#Flight_training
military:
https://jasoren.com/augmented-reality-military/
software and tool and hardware:
https://uxdesign.cc/designers-guide-to-hardware-and-software-for-mobile-ar-5c800503676d
skill:
https://ourcodeworld.com/articles/read/1091/7-essential-skills-for-ar-apps-developers
outcome and overview and motivation:
https://financesonline.com/augmented-reality-statistics/#:~:text=There%20are%202.5%20billion%20gamers,glasses)%20will%20exceed%202.5%20billion.
            ...
            <div class="tm-portfolio-item">
              ...
              <div class="tm-portfolio-description">
                <h3 class="tm-text-blue">
                  VIDEO
                  <span class="tm-title-small">(BY VIDEO TOI DI CODE DAO)</span>
                </h3>
                <p class="mb-0">
